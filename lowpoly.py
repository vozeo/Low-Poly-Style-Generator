...
# configurations and threshold values
...
def lowpoly(img,
    ...
    # get anchors
    anchor = getAnchor(v, gradientTV, anchorTV, scanIntervals, ksize)
    ...
    for t in triangleList:
        ...
        if rectcontains(rect, pt1) and rectcontains(rect, pt2) and rectcontains(
            ...
            ans.append([pt1, pt2, pt3, round(mean[2]) | round(mean[1]) << 8 | round(mean[0]) << 16])
    ...
    '''
    return imgfinal, edgemap, imgx, ans
